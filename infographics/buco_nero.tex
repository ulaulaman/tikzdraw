...
\begin{document}
	...
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle]
		...
		\node at (15,11.8) {\textcolor{black}{\fontsize{90}{91}\selectfont di un buco nero}};
		%
		\begin{scope}[shift={(0,1)}]
			\draw[fill=space,ultra thick] (0.5,8) rectangle (28,-6.7);
			%dida
			\begin{scope}
				\draw[fill=dida,thick] (12,-0.5) rectangle (28.2,7.8);
			...
			\draw (7,1) [color=moon,dashed,ultra thick,partial ellipse=180:0:6 and 3];
		...
		\begin{scope}[shift={(16,-15.5)}]
			%\draw (60,0) [color=red,partial ellipse=180:170:60 and 30];
