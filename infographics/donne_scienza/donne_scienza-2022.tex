...
\begin{document}
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle,>={[inset=0,angle'=27]Stealth}]
		...
		\begin{scope}[shift={(0,8)}]
			...
			\node at (8,-5) {\includegraphics[width=10cm]{img/2022/caroline_herschel}};
			%
		...
		\begin{scope}[shift={(0,-16)}]
			...
			\node at (8,0) {\includegraphics[width=10cm]{img/2022/winifred_merrill}};
			%
		...
		\begin{scope}[shift={(0,-46.5)}]
			...
			\node at (8,0) {\includegraphics[width=10cm]{img/2022/henrietta_swan}};
			%
		...
		\begin{scope}[shift={(0,-77.5)}]
			...
			\node at (8,0) {\includegraphics[width=10cm]{img/2022/cecilia_payne}};
			%
