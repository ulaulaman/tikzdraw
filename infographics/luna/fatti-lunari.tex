...
\begin{document}
	...
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle,>={[inset=0,angle'=27]Stealth}]
		...
		\begin{scope}[shift={(0,-25)}]
			...
			\node at (15,-4) {\textcolor{white}{\fontsize{23}{24}\selectfont Massa di 10 kg}};
			%
			...
			%
			\draw[fill=dida,thick] (6.2,-4.7) rectangle (24.3,-7.2);
			\node (example-textwidth-2) [right, align=left, text width=18cm, color=black, font=\fontsize{23pt}{24pt}\selectfont] at (6.5,-6) {Sulla Luna una massa di 10 kg ha un peso sei volte inferiore rispetto alla Terra.};
		\end{scope}
		%
		% phases
		%
		\begin{scope}[shift={(0,-42)}]
			...
			\node at (25,-1) {\textcolor{white}{\fontsize{23}{24}\selectfont I raggi del Sole}};
		...
		\begin{scope}[shift={(0,-92)}]
			...
			\draw[fill=title,thick] (7,11) rectangle (23,9);
			\node at (15,10) {\textcolor{black}{\fontsize{23}{24}\selectfont Teorie sulla formazione della Luna}};
			%
			% fission
			%
		...
		% great impact
		%
		\begin{scope}[shift={(0,-150)},decoration=zigzag]
			% 01
