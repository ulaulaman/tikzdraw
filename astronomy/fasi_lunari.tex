...
\begin{document}
	...
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle,]
		\begin{scope}
			...
			\node at (0.7 + 3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 4 maggio}};
			\node at (0.7 + 3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 15:51}};
			%
			\node at (0.7 + 3*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna piena}};
			\node at (0.7 + 3*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 12 maggio}};
			\node at (0.7 + 3*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 18:55}};
			%
			\node at (0.7 + 5*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Terzo quarto}};
			\node at (0.7 + 5*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 20 maggio}};
			\node at (0.7 + 5*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 13:58}};
			%
			\node at (0.7 + 7*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna nuova}};
			\node at (0.7 + 7*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 27 maggio}};
			\node at (0.7 + 7*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 05:02}};
		\end{scope}
	\end{tikzpicture}
\end{document}