...
\begin{document}
	...
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle,]
		\begin{scope}
			...
			\node at (2.7 + 3*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 3 settembre}};
			\node at (2.7 + 3*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 20:08}};
			%
			\node at (2.7 + 5*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna piena}};
			\node at (2.7 + 5*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 10 settembre}};
			...
			\node at (2.7 + 7*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 17 settembre}};
			\node at (2.7 + 7*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 23:52}};
			% quinta fase
			\node at (2.7 + 9*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna Nuova}};
			\node at (2.7 + 9*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 25 settembre}};
			\node at (2.7 + 9*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 23:54}};
		\end{scope}
	\end{tikzpicture}
\end{document}