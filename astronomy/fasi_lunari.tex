...
\begin{document}
	...
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle,]
		\begin{scope}
			...
			\node at (0.7 + 3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 3 giugno}};
			\node at (0.7 + 3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 05:40}};
			%
			\node at (0.7 + 3*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna piena}};
			\node at (0.7 + 3*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 11 giugno}};
			\node at (0.7 + 3*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 09:43}};
			%
			\node at (0.7 + 5*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Terzo quarto}};
			\node at (0.7 + 5*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 18 giugno}};
			\node at (0.7 + 5*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 21:19}};
			%
			\node at (0.7 + 7*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna nuova}};
			\node at (0.7 + 7*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 25 giugno}};
			\node at (0.7 + 7*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 12:31}};
		\end{scope}
	\end{tikzpicture}
\end{document}