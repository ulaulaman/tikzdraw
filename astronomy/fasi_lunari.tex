...
\begin{document}
	...
	\begin{tikzpicture}[background rectangle/.style={fill=white},show background rectangle,]
		\begin{scope}
			...
			\node at (0.7 + 3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 6 marzo}};
			\node at (0.7 + 3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 17:31}};
			%
			\node at (0.7 + 3*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna piena}};
			\node at (0.7 + 3*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 14 marzo}};
			\node at (0.7 + 3*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 07:54}};
			%
			\node at (0.7 + 5*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Terzo quarto}};
			\node at (0.7 + 5*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 22 marzo}};
			\node at (0.7 + 5*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 12:29}};
			%
			\node at (0.7 + 7*3.5,7) {\textcolor{white}{\fontsize{17}{18}\selectfont Luna nuova}};
			\node at (0.7 + 7*3.5,3) {\textcolor{white}{\fontsize{17}{18}\selectfont 29 marzo}};
			\node at (0.7 + 7*3.5,2) {\textcolor{white}{\fontsize{17}{18}\selectfont 11:57}};
		\end{scope}
	\end{tikzpicture}
\end{document}